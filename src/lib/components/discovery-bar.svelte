...
<aside
	class="flex w-full overflow-scroll h-full items-center max-w-2xl m-auto md:justify-center no-scrollbar px-4"
>
	<a
		href={`/`}
		class="list-none px-1 flex flex-col text-sm items-center flex-shrink-0 text-xs relative"
	>
		<div
		...
		<img
			class="h-[68px] w-[68px] rounded-full flex-shrink-0 border-4 border-solid mb-0.5 border-white {$page
	...
	<a href={`/add`} class="list-none px-1 flex flex-col text-sm items-center flex-shrink-0 text-xs">
		<img
			class="h-[68px] w-[68px] rounded-full flex-shrink-0 border-4 border-solid mb-0.5 border-white {$page
	...
	{#each sources as source}
		<a
			...
			class="list-none px-1 flex flex-col text-sm items-center flex-shrink-0 text-xs"
		>
			<img
				class="h-[68px] w-[68px] rounded-full flex-shrink-0 border-4 border-solid mb-0.5 border-white {$page
