...
>
	<a href={`/`} class="list-none px-1 flex flex-col items-center flex-shrink-0 text-xs relative">
		<div
	...
	<a href={`/add`} class="list-none px-1 flex flex-col items-center flex-shrink-0 text-xs">
		<img
			class="h-[68px] w-[68px] rounded-full flex-shrink-0 border-4 border-solid mb-0.5 border-white {$page
